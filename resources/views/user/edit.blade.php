...
<x-app-layout>
    <x-slot name="header">
        ...
        <form method="post" action="{{ route('admin.users.update', $user->id_usuario) }}" class="mt-6 space-y-6">
            @csrf
            @method('patch')
...
{{-- Password del usuario --}}
        ...
        <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
            ...
            <div>
                ...
                <x-text-input id="current_password" value="old('name', $user->password)"  name="current_password" type="password" class="mt-1 block w-full" autocomplete="current-password" />
